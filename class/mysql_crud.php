...
class Database{
	 ...
	 * Database class
	 */
	private $db_host = "fdb13.awardspace.net";  // Change as required
	private $db_user = "1819908_wines";  // Change as required
	private $db_pass = "w!nesdb01";  // Change as required
	private $db_name = "1819908_wines";	// Change as required
